...
KyNotes handles other people's private notes. Getting
...
Everyone who contributes to KyNotes — code, documentation, bug reports, security
...
We are building software for people who want control over their own notes. A
...
KyNotes deliberately runs adversarial review: human reviewers, and AI reviewers
...
whose private notes or encryption keys leaked. See
...
representing KyNotes. It also applies to behaviour outside these spaces when
...
through [GitHub Security Advisories](https://github.com/Busnes-app/kynotes-server/security/advisories),
